...
CREATE TABLE IF NOT EXISTS sys_infobright.decomposition_dictionary ( ID varchar(20) NOT NULL, RULE varchar(100) NOT NULL, COMMENT varchar(255) NOT NULL ) ENGINE=CSV;
CREATE TABLE IF NOT EXISTS sys_infobright.columns ( database_name VARCHAR( 255 ) NOT NULL, table_name VARCHAR( 255 ) NOT NULL, column_name VARCHAR( 255 ) NOT NULL, decomposition VARCHAR( 20 ) NOT NULL ) ENGINE=CSV;
set @had_decomp_dict_table= @@warning_count != 0;
...
ALTER TABLE general_log MODIFY COLUMN server_id INTEGER UNSIGNED NOT NULL, MODIFY COLUMN
thread_id INTEGER UNSIGNED NOT NULL, MODIFY COLUMN command_type varchar(64) NOT NULL,
MODIFY COLUMN user_host mediumtext NOT NULL, MODIFY COLUMN argument mediumtext NOT NULL;
SET GLOBAL general_log = @old_log_state;

SET @old_log_state = @@global.slow_query_log;
SET GLOBAL slow_query_log = 'OFF';
ALTER TABLE slow_log MODIFY COLUMN server_id INTEGER UNSIGNED NOT NULL, MODIFY COLUMN
insert_id INTEGER UNSIGNED NOT NULL, MODIFY COLUMN last_insert_id INTEGER UNSIGNED NOT
NULL, MODIFY COLUMN db varchar(512) NOT NULL;
