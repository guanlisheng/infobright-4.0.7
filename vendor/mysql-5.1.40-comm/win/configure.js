...
try 
{
    ...
    // ib_comment is set by build script,
    // ib_comment is set to rev. number and branch name
    var default_comment = "@ib_comment@";
    ...
    // if ib_comment is not set then use default.
    var template_comment = "ib_comment";
    if (default_comment.indexOf(template_comment) != -1)
		         default_comment = "Source distribution";
    ...
    if (actual_port == 0)
	{
       ...
       // from /etc/services if you can", but really, really meant 5029 when
       // they passed in 5029. When they pass in a specific value, let them
       ...
       //   use MYSQL_TCP_PORT_DEFAULT (at the time of this writing 5029)
       // 
    ...
    // if ib_license is not set then use default.
    var template_license = "ib_license";
    if (default_license.indexOf(template_license) != -1)
		         default_license = "GPL";
    configfile.WriteLine("SET (ib_license \"" +
                         default_license + "\")");
