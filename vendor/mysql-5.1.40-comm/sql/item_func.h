...
class Item_func_is_decomposition_rule_correct : public Item_int_func
{
public:
	Item_func_is_decomposition_rule_correct(Item* a)  : Item_int_func(a) {}
  longlong val_int();
  const char *func_name() const { return "is_decomposition_rule_correct"; }
  void fix_length_and_dec() { decimals= 0; maybe_null=0; }
};
