...
class Create_func_is_decomposition_rule_correct : public Create_func_arg1
{
public:
  virtual Item *create(THD *thd, Item *arg1);

  static Create_func_is_decomposition_rule_correct s_singleton;

protected:
  Create_func_is_decomposition_rule_correct() {}
  virtual ~Create_func_is_decomposition_rule_correct() {}
};
...
Create_func_is_decomposition_rule_correct Create_func_is_decomposition_rule_correct::s_singleton;

Item*
Create_func_is_decomposition_rule_correct::create(THD *thd, Item *arg1)
{
  thd->lex->set_stmt_unsafe();
  thd->lex->safe_to_cache_query = 1;
  return new (thd->mem_root) Item_func_is_decomposition_rule_correct(arg1);
}
...
static Native_func_registry func_array[] =
{
  ...
  { { C_STRING_WITH_LEN("IS_DECOMPOSITION_RULE_CORRECT") }, BUILDER(Create_func_is_decomposition_rule_correct)},
