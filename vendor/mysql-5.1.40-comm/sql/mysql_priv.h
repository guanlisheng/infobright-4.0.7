...
#include "../../../src/storage/brighthouse/common/ProcessType.h"
...
#define SELECT_ROUGHLY			        (ULL(1) << 34)     // SELECT
...
bool handle_select(THD *thd, LEX *lex, select_result *result,
                   ulong setup_tables_done_option, int optimize_after_bh = FALSE, int free_join_from_bh = FALSE);
bool mysql_select(THD *thd, Item ***rref_pointer_array,
                  TABLE_LIST *tables, uint wild_num,  List<Item> &list,
                  COND *conds, uint og_num, ORDER *order, ORDER *group,
                  Item *having, ORDER *proc_param, ulonglong select_type, 
                  select_result *result, SELECT_LEX_UNIT *unit, 
                  SELECT_LEX *select_lex, int optimize_after_bh = FALSE, int free_join_from_bh =  FALSE);
...
bool mysql_handle_derived(LEX *lex, bool (*processor)(THD *thd,
                                                      LEX *lex,
                                                      TABLE_LIST *table),
						  List<st_select_lex_unit>* derived_optimized = NULL); // derived tables optimized partially in BrightHouse
...
int open_and_lock_tables_derived(THD *thd, TABLE_LIST *tables, bool derived, unsigned char part = 0);
