...
public:
  ...
  */
  ...
  bool optimize_completed;	// remembers whether optimization was completed during the first optimize(..) call
  ...
  */  
  ...
  int prepare(Item ***rref_pointer_array, TABLE_LIST *tables, uint wind_num,
	      ...
	      SELECT_LEX_UNIT *unit);
  int optimize(unsigned char part = 0);
  int reinit();
  void exec();
  int destroy();
  void restore_tmp();
...
COND *remove_eq_conds(THD *thd, COND *cond, Item::cond_result *cond_value, unsigned char part = 0);
